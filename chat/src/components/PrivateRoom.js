    ...
    render() {
        ...
        return (
            <form onSubmit={(e) => {
                ...
                <div className="form-group">
                    <label htmlFor="InputGuest">  Invite friend</label>
                    <input type="text" className="form-control" id="InputGuest" aria-describedby="emailHelp" placeholder="Enter friend id" name='guest' />
                </div>
